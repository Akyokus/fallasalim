                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <?php if(isset($success)): ?>
                            <h3><?= $success ?></h3>
                        <?php endif; ?>
                        <form action="<?= site_url('el-gonder') ?>" class="form-group" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?= $teller['id'] ?>">
                        <div class="text-28 mb-3 font-weight-bold">El Falı</div>
                        <div class="text-muted">Lütfen ellerinizin ön yüzünün ve arka yüzünün fotoğrafını ekleyin</div>
