        ...
        <div class="bg-white rounded p-md-5 p-4">
            <div class="row">
                <div class="col-md-3 d-none d-md-block">
                    ...
                    <a href="" class="avatar avatar-md bg-light w-80 mx-auto"
                       style="background-image: url(https://randomuser.me/api/portraits/women/2.jpg);"><i
                                class="on avatar-status"></i></a>
                ...
                <div class="col-md-9">
                    ...
                    <?php if (isset($success)): ?>
                        <h3><?= $success ?></h3>
                    <?php endif; ?>
                    <div class="text-28 mb-3 font-weight-bold">Yıldızname Falı</div>
                    <form action="<?= site_url('yildizname-gonder') ?>" class="form-group" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input required type="text" name="bdate" class="form-control datepic"
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea required minlength="25" class="form-control" name="spesifik"
                                          placeholder="Spesifik Soru" rows="5"></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <input required type="text" name="telno" class="form-control form-control-lg"
                                   placeholder="Telefon Numarası">
                            <div class="my-3">
                                <div class="text-danger font-weight-bold py-1">Telefonlu yorum türünü seçerseniz
                                    yorumcumuzun sana ulaşabilmesi için 850 8406202 numaralı hattan gelen çağrıyı kabul
                                    etmelisin.
                                </div>
                            ...
                            <div class="form-group bg-secondary rounded p-4">
                                ...
                                <div required class="custom-control custom-checkbox">
                                    <input name="havuz" value="1" type="checkbox" class="custom-control-input"
                                           id="havuz">
                                    <label class="custom-control-label" for="havuz">
                                        Falınız söz verilen süre sonunda hala yorumlanmamışsa havuza düşer ve uygun bir
                                        yorumcuya devredilir.
                                    </label>
                                </div>
                            </div>
                            <div class="form-group bg-dark rounded p-4">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input required name="kullanım" value="1" required type="checkbox"
                                           class="custom-control-input" id="kullanim">
                                    <label class="custom-control-label" for="kullanim">
                                        Kayıt olarak ya da giriş yaparak Kullanım ve Gizlilik Koşullarını Aydınlanma ve
                                        Rıza Metnini okuduğumu ve kabul ettiğimi beyan ederim.
                                    </label>
                                </div>
                            </div>
