...
<div class="filter bg-white bg-header-lg mb-4">
    <div class="container">
        <div class="row row-xs d-none d-md-flex">
            ...
            <div class="col">
                <a href="<?= site_url('yildizname') ?>" class="fale-category py-4 rounded d-flex flex-column my-2 active">
            ...
            <div class="col-md-3">
                <div class="card py-5 px-3 mb-4">
                    ...
                    <div class="flex-fill text-center mt-3">
                        ...
                        <form action="<?= site_url('yildizname-gonder') ?>" method="post" >
                            <div class="px-4">
                                <input type="hidden" name="id" value="<?= $tellers[$i]['id'] ?>">
                                <?php if ($tellers[$i]['state'] == 1): ?>
                                    <button value="<?= site_url('yildizname-gonder') ?>" class="btn btn-block btn-primary-gradient btn-rounded mt-3">Fallaşalım mı ?</button>
                                <?php else: ?>
