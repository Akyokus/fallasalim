        ...
        <div class="container">
            <div class="bg-white rounded p-md-5 p-4">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <form action="<?= site_url('iskambil-gonder') ?>" class="form-group" method="post">
                            ...
                            <?php if(isset($success)): ?>
                                <h3><?= $success ?></h3>
                            <?php endif; ?>
                            <div class="text-28 mb-3 font-weight-bold">İskambil Falı</div>
                            <input type="hidden" name="card-selects">
                            <div class="d-flex align-items-center py-4">
                                <div>Toplam Kart :</div>
                                <div class="font-weight-bold ml-2 mr-4 text-primary">52</div>
                                <div>Kalan Kart :</div>
