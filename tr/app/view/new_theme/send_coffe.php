            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <?php if(isset($success)): ?>
                        <h3><?= $success ?></h3>
                    <?php endif; ?>
                    <div class="text-28 mb-3 font-weight-bold">Kahve Falı</div>
                    <div class="text-16 font-weight-bold">Fincan Fotoğrafların</div>
                    <div class="text-muted">Lütfen fincanına ait 4, tabağına ait 1 fotoğraf ekle</div>
                    <form action="<?= site_url('kahve-gonder') ?>" class="form-group" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?= $teller['id'] ?>">
                    <div class="d-flex align-items-center my-3 flex-scroll">
                        <div  class="bg-white p-5 rounded media media-16x9 cover-0 media-select cursor-pointer mr-3" id="cover-0">
                        </div>
                        <input type="file" name="image0" class="media-input d-none" id="file-cover-0" data-preview="cover-0">
                        <div class="bg-white p-5 rounded media media-16x9 cover-1 media-select cursor-pointer mr-3" id="cover-1">
                        </div>
                        <input type="file" name="image1" class="media-input d-none" id="file-cover-1" data-preview="cover-1">
                        <div class="bg-white p-5 rounded media media-16x9 cover-2 media-select cursor-pointer mr-3" id="cover-2">
                        </div>
                        <input type="file" name="image2" class="media-input d-none" id="file-cover-2" data-preview="cover-2">
                        <div class="bg-white p-5 rounded media media-16x9 cover-3 media-select cursor-pointer mr-3" id="cover-3">
                        </div>
                        <input type="file" name="image3" class="media-input d-none" id="file-cover-3" data-preview="cover-3">
                        <div class="bg-white p-5 rounded media media-16x9 cover-4 media-select cursor-pointer mr-3" id="cover-4">
                        </div>
                        <input type="file" name="image4" class="media-input d-none" id="file-cover-4" data-preview="cover-4">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select required name="yorum_turu" class="custom-select">
                            ...
                            <option value="1">Yazili</option>
                            <option value="2">Sesli</option>
                            <option value="3">Görüntülü</option>
                            <option value="4">Telefonla</option>
